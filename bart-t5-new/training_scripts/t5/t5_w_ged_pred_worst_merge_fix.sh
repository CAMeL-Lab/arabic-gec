...
# OUTPUT_DIR=/scratch/ba63/gec/models/gec/qalb14-15/t5_w_ged_pred_worst_merge_fix
...
# OUTPUT_DIR=/scratch/ba63/gec/models/gec/mix_check/t5_w_ged_pred_worst_merge_fix
...
OUTPUT_DIR=/scratch/ba63/gec/models/gec/mix_segmented/t5_w_ged_pred_worst_merge_fix
