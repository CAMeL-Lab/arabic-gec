...
# OUTPUT_DIR=/scratch/ba63/gec/models/gec/qalb14/binary/t5_w_ged_check
# TRAIN_FILE=/scratch/ba63/gec/data/bart-t5/qalb14/binary/wo_camelira/train.json
# LABELS=/scratch/ba63/gec/data/ged++/qalb14/binary/wo_camelira/labels.txt

# OUTPUT_DIR=/scratch/ba63/gec/models/gec/qalb14-15/binary/t5_w_ged_check
...
OUTPUT_DIR=/scratch/ba63/gec/models/gec/mix/binary/t5_w_ged_check
...
# OUTPUT_DIR=/scratch/ba63/gec/models/gec/mix_segmented/t5_w_ged
