...
OUTPUT_DIR=/scratch/ba63/gec/models/gec/qalb14/t5_w_ged
...
# OUTPUT_DIR=/scratch/ba63/gec/models/gec/mix/t5_w_ged
...
# test_file=/scratch/ba63/gec/data/bart-t5/qalb14-nopnx-ged/wo_camelira/tune_preds.json
# PRED_FILE=mix_tune.preds.merge_fix
# test_file=/scratch/ba63/gec/data/bart-t5/qalb15/wo_camelira/dev_preds.json
...
# test_file=/scratch/ba63/gec/data/bart-t5/zaebuc/wo_camelira/dev_preds.json
