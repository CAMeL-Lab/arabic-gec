...
OUTPUT_DIR=/scratch/ba63/gec/models/gec/qalb14/bart_w_camelira_ged_pred_worst
...
# OUTPUT_DIR=/scratch/ba63/gec/models/gec/mix/bart_w_camelira_ged_pred_worst
...
# PRED_FILE=zaebuc_dev.preds.merge_fix
