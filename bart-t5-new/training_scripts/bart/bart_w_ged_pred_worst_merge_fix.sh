...
# OUTPUT_DIR=/scratch/ba63/gec/models/gec/qalb14/bart_w_ged_pred_worst_merge_fix
...
# OUTPUT_DIR=/scratch/ba63/gec/models/gec/qalb14-15/bart_w_ged_pred_worst_merge_fix
# TRAIN_FILE=/scratch/ba63/gec/data/bart-t5/qalb14-15/wo_camelira/train_preds_worst.json
# LABELS=/scratch/ba63/gec/data/ged++/qalb14-15/wo_camelira/labels.txt


# OUTPUT_DIR=/scratch/ba63/gec/models/gec/mix_check/bart_w_ged_pred_worst_merge_fix
...
# OUTPUT_DIR=/scratch/ba63/gec/models/gec/mix_segmented/bart_w_ged_pred_worst_merge_fix
...
OUTPUT_DIR=/scratch/ba63/gec/models/gec/qalb14-15_segmented/bart_w_ged_pred_worst_merge_fix
TRAIN_FILE=/scratch/ba63/gec/data/bart-t5/qalb14-15_segmented/wo_camelira/train_preds_worst.json
