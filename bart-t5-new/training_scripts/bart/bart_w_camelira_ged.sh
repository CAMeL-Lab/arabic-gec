...
# TRAIN_FILE=/scratch/ba63/gec/data/bart-t5/qalb14/full/w_camelira/train.json
# LABELS=/scratch/ba63/gec/data/ged++/qalb14/full/w_camelira/labels.txt
...
TRAIN_FILE=/scratch/ba63/gec/data/bart-t5/mix/binary/w_camelira/train.json
LABELS=/scratch/ba63/gec/data/ged++/mix/binary/w_camelira/labels.txt


# OUTPUT_DIR=/scratch/ba63/gec/models/gec/mix_segmented/bart_w_camelira_ged
...
# OUTPUT_DIR=/scratch/ba63/gec/models/gec/qalb14-15_segmented/bart_w_camelira_ged
