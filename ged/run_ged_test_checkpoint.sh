...
export DATA_DIR=/scratch/ba63/gec/data/ged-nopnx/qalb14/wo_camelira
export MAX_LENGTH=256
export OUTPUT_DIR=/scratch/ba63/gec/models/ged-nopnx/qalb14/wo_camelira
export BATCH_SIZE=32
export SEED=42
export pred_mode=train
...
do
    ...
    python metrics.py --pred $checkpoint/qalb14_${pred_mode}.preds.txt \
                      ...
                      --labels $DATA_DIR/single_labels.txt \
                      --include_uc \
                      --output $checkpoint/qalb14_${pred_mode}.results.txt
