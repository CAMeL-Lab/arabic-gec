...
do
    ...
    ALIGNMENT=/scratch/ba63/gec/data/gec_camelira/alignment/${data}_${split}.txt.nopnx

    if [ -f "$ALIGNMENT" ]; then
        printf "Creating ARETA Tags for $ALIGNMENT \n"
        OUTPUT=/scratch/ba63/gec/data/gec_camelira/areta_tags/${data}_${split}.areta.txt.nopnx
        ENRICHED_OUTPUT=/scratch/ba63/gec/data/gec_camelira/areta_tags/${data}_${split}.areta+.txt.nopnx
...
# python /home/ba63/arabic_error_type_annotation/annotate_err_type_ar.py \
#    --alignment /scratch/ba63/gec/data/ged/qalb14/w_camelira/tune_wo_c.to.tune_w_c.txt \
#    --output_path /scratch/ba63/gec/data/ged/qalb14/w_camelira/tune_wo_c.to.tune_w_c.areta.txt \
#    --enriched_output_path /scratch/ba63/gec/data/ged/qalb14/w_camelira/tune_wo_c.to.tune_w_c.areta+.txt
