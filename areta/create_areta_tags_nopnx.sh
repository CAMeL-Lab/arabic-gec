...
do
    ...
    ALIGNMENT=/scratch/ba63/gec/data/alignment/modeling_alignment/${data}/${data}_${split}.nopnx.txt

    if [ -f "$ALIGNMENT" ]; then
        printf "Creating ARETA Tags for $ALIGNMENT \n"
        OUTPUT=/scratch/ba63/gec/data/alignment/modeling_areta_tags_improved/${data}/${data}_${split}.areta.nopnx.txt
        ENRICHED_OUTPUT=/scratch/ba63/gec/data/alignment/modeling_areta_tags_improved/${data}/${data}_${split}.areta+.nopnx.txt
