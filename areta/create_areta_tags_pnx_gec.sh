...
model_dir=/scratch/ba63/gec/models/pnx-gec/t5

for checkpoint in $model_dir $model_dir/checkpoint-*
do

        align_file=$checkpoint/qalb14_tune.preds.to.tgt.alignment.txt
        ...
        python /home/ba63/arabic_error_type_annotation/annotate_err_type_ar.py \
            ...
            --output_path $checkpoint/qalb14_tune.preds.to.tgt.areta.txt \
            --enriched_output_path $checkpoint/qalb14_tune.preds.to.tgt.areta+.txt
        rm fout2.basic
