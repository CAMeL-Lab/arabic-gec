...
sys=/scratch/ba63/gec/models/gec/qalb14/coarse/t5_w_camelira_ged_pred_worst
pred_file=qalb14_dev.preds
test_file=/scratch/ba63/gec/data/bart-t5/qalb14/coarse/w_camelira/dev_preds.json
...
# sys=/scratch/ba63/gec/models/gec/qalb14-15/binary/t5_w_camelira_ged_pred_worst
...
# sys=/scratch/ba63/gec/models/gec/mix/binary/t5_w_camelira_ged_pred_worst
