...
# sys=/scratch/ba63/gec/models/gec/qalb14/full/t5
# pred_file=qalb14_dev.preds
# test_file=/scratch/ba63/gec/data/bart-t5/qalb14/full/wo_camelira/dev_preds.json
...
sys=/scratch/ba63/gec/models/gec/qalb14-15/full/t5
pred_file=qalb15_dev.preds
test_file=/scratch/ba63/gec/data/bart-t5/qalb15/full/wo_camelira/dev_qalb14-15_preds.json
...
# sys=/scratch/ba63/gec/models/gec/mix/full/t5
# pred_file=zaebuc_dev.preds
# test_file=/scratch/ba63/gec/data/bart-t5/zaebuc/full/wo_camelira/dev_mix_preds.json
