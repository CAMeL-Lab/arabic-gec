...
# sys=/scratch/ba63/gec/models/gec/qalb14/binary/t5_w_ged_pred_worst
# pred_file=qalb14_dev.preds
# test_file=/scratch/ba63/gec/data/bart-t5/qalb14/binary/wo_camelira/dev_preds.json
...
sys=/scratch/ba63/gec/models/gec/qalb14-15/binary/t5_w_ged_pred_worst
...
# sys=/scratch/ba63/gec/models/gec/mix/binary/t5_w_ged_pred_worst
# pred_file=zaebuc_dev.preds
# test_file=/scratch/ba63/gec/data/bart-t5/zaebuc/binary/wo_camelira/dev_mix_preds.json
