...
# sys=/scratch/ba63/gec/models/gec/qalb14/binary/bart_w_camelira_ged_pred_worst
# pred_file=qalb14_dev.preds
# test_file=/scratch/ba63/gec/data/bart-t5/qalb14/binary/w_camelira/dev_preds.json
...
sys=/scratch/ba63/gec/models/gec/qalb14-15/binary/bart_w_camelira_ged_pred_worst
pred_file=qalb15_dev.preds
test_file=/scratch/ba63/gec/data/bart-t5/qalb15/binary/w_camelira/dev_qalb14-15_preds.json
...
# sys=/scratch/ba63/gec/models/gec/mix/binary/bart_w_camelira_ged_pred_worst
# pred_file=zaebuc_dev.preds
# test_file=/scratch/ba63/gec/data/bart-t5/zaebuc/binary/w_camelira/dev_mix_preds.json
