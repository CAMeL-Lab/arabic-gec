...
# OUTPUT_DIR=/scratch/ba63/gec/models/gec/qalb14-15/t5
# TRAIN_FILE=/scratch/ba63/gec/data/bart-t5/qalb14-15/wo_camelira/train.json

# OUTPUT_DIR=/scratch/ba63/gec/models/gec/qalb14/t5
# TRAIN_FILE=/scratch/ba63/gec/data/bart-t5/qalb14/wo_camelira/train.json

# OUTPUT_DIR=/scratch/ba63/gec/models/gec/mix_check/t5
# TRAIN_FILE=/scratch/ba63/gec/data/bart-t5/mix/wo_camelira/train.json

# OUTPUT_DIR=/scratch/ba63/gec/models/gec/mix_segmented/t5
# TRAIN_FILE=/scratch/ba63/gec/data/bart-t5/mix_segmented/wo_camelira/train.json

OUTPUT_DIR=/scratch/ba63/gec/models/gec/mix_up/t5
TRAIN_FILE=/scratch/ba63/gec/data/bart-t5/mix_up/wo_camelira/train.json
