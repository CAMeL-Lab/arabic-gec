...
_import_structure = {
    ...
    "models.mbart_areta": ["MBartConfig"],
    "models.mbart_ged": ["MBartConfig"],
    "models.bert_pnx": ["BertConfig"],
    "models.mbart50": [],
...
try:
    ...
    _import_structure["models.bert_pnx"].extend(
        [
            "BertModelPNX",
        ]
    )
    _import_structure["models.mbart_ged"].extend(
        [
            "MBartForConditionalGenerationGED",
            "MBartModelGED",
        ]
    )
    _import_structure["models.mbart_areta"].extend(
        [
            "MBartForConditionalGenerationARETA",
            "MBartModelARETA",
        ]
    )
